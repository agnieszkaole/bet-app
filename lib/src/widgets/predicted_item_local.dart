                      ...
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => PredictedResultEdit(
                            teamHomeName: widget.predictedMatch['teamHomeName'],
                            teamAwayName: widget.predictedMatch['teamAwayName'],
                            teamHomeLogo: widget.predictedMatch['teamHomeLogo'],
                            teamAwayLogo: widget.predictedMatch['teamAwayLogo'],
